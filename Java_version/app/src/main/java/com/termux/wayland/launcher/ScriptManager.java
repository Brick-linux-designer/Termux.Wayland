package com.termux.wayland.launcher;
 ...
 *
 * FileProvider authority : com.termux.wayland.fileprovider
 * URI exemple : content://com.termux.wayland.fileprovider/scripts/system/setup-x11.sh
 */
public class ScriptManager {

    private static final String TAG           = "ScriptManager";
    private static final String AUTHORITY     = "com.termux.wayland.fileprovider";
     ...
     *   // → content://com.termux.wayland.fileprovider/scripts/system/setup-x11.sh
     */
